...
Lately, I've been integrating AI into my design process to support decision-making, speed up exploration, and bring better solutions to the table faster. </p>
            <p className="text-lg md:text-xl text-aether-white font-light leading-relaxed">
